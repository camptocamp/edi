...
class EDIExchangeType(models.Model):
    ...
    filename_pattern_settings = Serialized(default={}, compute="_compute_advanced_settings")
    ...
    def _compute_advanced_settings(self):
        for rec in self:
            ...
            rec.filename_pattern_settings = rec.advanced_settings.get("filename_pattern", {})
