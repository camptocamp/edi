...
class TestDespatchAdviceMix(SavepointCase):
    ...
    def setUpClass(cls):
        ...
        grab several DO for one PO and check that everything is created properly:
    ...
    def test_00(self):
        ...
        # pickings_draft = self.env["stock.picking"].search(
        #     [("origin", "=", self.purchase_order.name), ("state", "=", "draft")]
        # )
