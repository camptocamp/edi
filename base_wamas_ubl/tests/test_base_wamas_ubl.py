...
# FIXME: use with statement in all tests using file_open
from odoo.tools import file_open

from odoo.addons.account.tests.common import AccountTestInvoicingCommon

# FIXME: all simple convertion tests should move to lib/wamas/tests and there should be a test that runs the lib tests
...
class TestBaseWamas(TransactionCase):
    ...
    def _wamas_ubl_wiz_check(self, input_file, expected_output_file):
        ...
        str_expected_output = file_open(expected_output_file, "r").read().strip("\n")
