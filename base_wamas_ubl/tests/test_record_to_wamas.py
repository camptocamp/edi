...
class TestRecordToWAMAS(common.TransactionCase):
    ...
    def test_export_without_telegram(self):
        with self.assertRaisesRegex(ValueError, "Please define telegram_type."):
            input_dict = {"name": "David", "age": 16}
            self.env["base.wamas.ubl"].record_to_wamas(input_dict, "")

    def test_export_invalid_dict(self):
        with self.assertRaisesRegex(ValueError, "The specific dict is not valid."):
            input_dict = ["David", 16]
            self.base_wamas_ubl.record_to_wamas(input_dict, "LST")
    ...
    def test_export_with_LST_telegram(self):
        ...
        output = self.base_wamas_ubl.record_to_wamas(dict_input, "LST")
    ...
    def test_export_with_KST_telegram(self):
        ...
        dict_input = literal_eval(file_open(dict_data["input"], "r").read())
        output = self.base_wamas_ubl.record_to_wamas(dict_input, "KST")
        self.assertEqual(output, expected_output)
    ...
    def test_export_with_ART_telegram(self):
        ...
        dict_input = literal_eval(file_open(dict_data["input"], "r").read())
        output = self.base_wamas_ubl.record_to_wamas(dict_input, "ART")
        self.assertEqual(output, expected_output)
    ...
    def test_export_with_ARTE_telegram(self):
        ...
        dict_input = literal_eval(file_open(dict_data["input"], "r").read())
        output = self.base_wamas_ubl.record_to_wamas(dict_input, "ARTE")
        self.assertEqual(output, expected_output)
    ...
    def test_export_with_ARTEAN_telegram(self):
        ...
        dict_input = literal_eval(file_open(dict_data["input"], "r").read())
        output = self.base_wamas_ubl.record_to_wamas(dict_input, "ARTEAN")
        self.assertEqual(output, expected_output)
    ...
    def test_export_with_KSTAUS_telegram(self):
        ...
        dict_input = literal_eval(file_open(dict_data["input"], "r").read())
        output = self.base_wamas_ubl.record_to_wamas(dict_input, "KSTAUS")
        self.assertEqual(output, expected_output)
