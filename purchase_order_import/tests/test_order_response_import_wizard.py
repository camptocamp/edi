...
class TestOrderResponseImportWizard(TestOrderResponseImportCommon):
    ...
    def test_unknown_status(self):
        ...
        self._assert_user_error_message(
            error,
            self.env._("Unknown status '%(status)s'.", status="unknown"),
        )
    ...
    def test_conditional_response_requires_all_lines(self):
        ...
        self._assert_user_error_message(
            ...
            self.env._(
                ...
                received_line_ids=[],
                expected_line_ids=self.purchase_order.order_line.ids,
            ),
        )
    ...
    def test_conditional_response_rejects_wrong_line_id(self):
        ...
        self._assert_user_error_message(
            ...
            self.env._(
                ...
                "received: %(received_line_ids)s\n"
                "expected: %(expected_line_ids)s\n",
                received_line_ids=[str(self.line1.id), "WRONG"],
                expected_line_ids=self.purchase_order.order_line.ids,
            ),
        )
    ...
    def test_conditional_response_amends_qty_without_backorder(self):
        ...
        self.assertEqual(
            ...
            self.env._("No backorder planned by the supplier."),
        )
